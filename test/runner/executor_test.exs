defmodule Runic.Runner.ExecutorTest do
  ...
  describe "inline executor" do
    ...
    test "policy executor: :inline emits failed runnable events only in durable mode", %{
      ...
      {:ok, _pid} = Runic.Runner.start_workflow(runner, :wf_inline_durable_fail, durable_workflow)
      ...
      {:ok, _pid} = Runic.Runner.start_workflow(runner, :wf_inline_default_fail, default_workflow)
