defmodule Runic.TestSupport.SnapshotStoreWithoutTail do
  ...
  def init_store(opts) do
    ...
    events_table = Module.concat(runner_name, SnapshotEvents)
    counters_table = Module.concat(runner_name, SnapshotCounters)
    snapshots_table = Module.concat(runner_name, Snapshots)
    calls_table = Module.concat(runner_name, SnapshotCalls)
